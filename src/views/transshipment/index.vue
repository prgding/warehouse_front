<template>
  ...
  <div>
    <el-form class="searchForm" inline>
      <el-form-item label="目标仓库：">
        <el-select v-model="params.targetStoreId" clearable placeholder="请选择仓库" style="width: 120px;">
      ...
      <el-form-item label="源仓库：">
        <el-select v-model="params.sourceStoreId" clearable placeholder="请选择仓库" style="width: 120px;">
          <el-option v-for="store of storeList" :key="store.storeId" :label="store.storeName" :value="store.storeId"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
        <el-input v-model="params.targetProductName" clearable placeholder="目标商品名称" style="width: 130px;"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input v-model="params.sourceProductName" clearable placeholder="源商品名称" style="width: 120px;"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input v-model="params.createName" clearable placeholder="调货人" style="width: 120px;"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  <!-- 表格 -->
  <el-table :data="transshipmentPageList" border size="large" stripe style="width: 100%; margin-top: 10px;" table-layout="auto">
    <el-table-column label="调货编号" prop="transId" sortable/>
    <el-table-column label="目标仓库名" prop="targetStoreName" sortable/>
    <el-table-column label="目标商品名" prop="targetProductName" sortable/>
    <el-table-column label="源仓库名" prop="sourceStoreName" sortable/>
    <el-table-column label="源商品名" prop="sourceProductName" sortable/>
    <el-table-column label="调货量" prop="transNum" sortable/>
    ...
    <el-table-column label="调货人" prop="createName" sortable/>
    <el-table-column label="调货时间" prop="createTime" sortable/>
