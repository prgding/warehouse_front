<template>
  ...
  <div>
    <el-form class="searchForm">
      <el-form-item label="角色名:">
        <el-input v-model="params.roleName" clearable placeholder="角色名" style="width: 120px;"></el-input>
      </el-form-item>
      <el-form-item label="角色代码:" style="margin-left: 30px;">
        <el-input v-model="params.roleCode" clearable placeholder="角色代码" style="width: 120px;"></el-input>
      </el-form-item>
      <el-form-item label="角色状态:" style="margin-left: 30px;">
        <el-select v-model="params.roleState" clearable placeholder="角色状态" style="width: 120px;">
          <el-option label="禁用" value="0"></el-option>
          <el-option label="启用" value="1"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item style="margin-left: 30px;">
        <el-button style="margin-left: 10px;" type="primary" @click="getRoleList">
          <el-icon>
    ...
    <div>
      <el-button type="primary" @click="openRoleAdd()">
        <el-icon>
          <svg class="icon" height="200" p-id="2197" t="1646977404025" version="1.1" viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- 表格 -->
  <el-table :data="rolePageList" border size="large" stripe style="width: 100%; margin-top: 10px;" table-layout="auto">
    <el-table-column label="角色ID" prop="roleId" sortable/>
    <el-table-column label="角色名" prop="roleName" sortable/>
    <el-table-column label="角色描述" prop="roleDesc"/>
    <el-table-column label="角色代码" prop="roleCode" sortable/>
    ...
    <el-table-column label="操作">
      <template #default="props">
        <el-button :icon="Edit" circle title="修改角色" type="primary" @click="openRoleUpdate(props.row)"/>
        <el-button :icon="Delete" circle title="删除角色" type="danger" @click="deleteRole(props.row.roleId)"/>
        <el-button type="warning" @click="updateState(props.row)">{{ props.row.roleState == "1" ? "禁用" : "启用" }}</el-button>
        <el-button v-if="props.row.roleState==1" type="primary" @click="openUpdateAuth(props.row)">更改权限</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 分页 -->
