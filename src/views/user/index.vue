  ...
  <div>
    <el-form class="searchForm">
      ...
      <el-form-item label="用户类型:" style="margin-left: 30px;">
        <el-select v-model="params.userType" clearable placeholder="用户类型" style="width: 120px;">
          <el-option v-for="role of roleList" :key="role.roleId" :label="role.roleName" :value="role.roleId"></el-option>
        </el-select>
      </el-form-item>
  ...
  <el-table ref="multipleTableRef" :data="userList" border size="large" stripe style="width: 100%; margin-top: 10px;" table-layout="auto" @selection-change="handleSelectionChange">
    ...
    <el-table-column label="操作">
      <template #default="props">
        ...
        <el-button v-if="props.row.userState==1" type="primary" @click="openAssignRole(props.row)">分配角色</el-button>
        <el-button v-if="props.row.userState==1" type="primary" @click="openUpdateAuth(props.row)">更改权限</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 分页 -->
